...
export default function ImageUpload({ onChange, style }: any) {
  ...
  return (
    <Stack justifyContent="center" css={{ backgroundColor: style.backgroundColor, color: style.color, borderWidth: '1px', borderStyle: 'solid', bordercolor: style.backgroundColor, borderRadius: '$md', padding: '8px' }} className={styles.imageUpload}>
